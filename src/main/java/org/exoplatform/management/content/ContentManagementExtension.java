...
//
	   	ManagedResource.Registration content = registration.registerManagedResource(description("Content Managed Resource, responsible for handling management operations on contents."));
...
//
	   	content.registerOperationHandler(OperationNames.READ_RESOURCE, new ContentSiteReadResource(), description("Lists available contents sites"));
//
